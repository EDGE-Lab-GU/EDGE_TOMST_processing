...
3.  Before importing the data from your TOMST loggers you will need a datatable with the following information:
    ...
    *tomst_id:* Add the TOMST id number from the logger.
    ...
    Since the TOMST data loggers usually start recording data before being installed in the field, we need installation date information which we will use to filter out values that were recorded before the logger was installed.
